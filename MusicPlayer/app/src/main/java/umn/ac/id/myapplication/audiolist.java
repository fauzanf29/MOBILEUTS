...
public class audiolist extends RecyclerView.Adapter {

    private List audioDataSet;
    private LayoutInflater mInflater;
    Context mContext;

    public audiolist(Context context, List audioModelList){
    ...
    public AudioViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        // create a new view
        View v = mInflater.inflate(R.layout.audiolist, viewGroup, false);
